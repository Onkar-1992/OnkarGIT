...
public class Registration {
	...
	public void i_should_see_the_message_for_email_user_password_and_confirm_password(String string) {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	        ...
	        Assert.assertEquals(emailError.isDisplayed(), "Email error message is not displayed");
	        Assert.assertEquals(passwordError.isDisplayed(), "Password error message is not displayed");
	        Assert.assertEquals(confirmPasswordError.isDisplayed(), "Confirm password error message is not displayed");
